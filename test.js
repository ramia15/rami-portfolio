...
gsap.set(spans[0], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[0], {
    rotation: 360,
...
gsap.set(spans[1], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[1], {
    rotation: 360,
...
gsap.set(spans[2], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[2], {
    rotation: 360,
...
gsap.set(spans[3], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[3], {
    rotation: 360,
...
gsap.set(spans[4], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[4], {
    rotation: 360,
...
gsap.set(spans[5], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[5], {
    rotation: 360,
...
gsap.set(spans[6], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[6], {
    rotation: 360,
...
gsap.set(spans[7], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[7], {
    rotation: 360,
...
gsap.set(spans[8], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[8], {
    rotation: 360,
...
gsap.set(spans[9], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[9], {
    rotation: 360,
...
gsap.set(spans[10], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[10], {
    rotation: 360,
...
gsap.set(spans[11], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[11], {
    rotation: 360,
    transformOrigin: '-20vw -12vh',
    boxShadow: '-100vmin 0 13.000772814922291vmin currentColor',
...
gsap.set(spans[12], {transform: 'translate3d(0, 0, 0)'}); 
gsap.to(spans[12], {
    rotation: 360,
    transformOrigin: '-14vw 10vh',
    boxShadow: '-100vmin 0 12.608171893618925vmin currentColor',
